...
export const faqData: FAQItem[] = [
    ...
    },
    {
        ...
        additionalContent: 'Feel free to contact us and we\'ll help you out as soon as we can.'
    },
    {
        ...
        additionalContent: 'Find out more information by reading the license.'
    },
    {
    ...
    },
    {
        ...
        answer: 'The free version of Windster includes a minimal style guidelines, component variants, and a dashboard page with the mobile version alongside it.',
        additionalContent: 'You can use this version for any purposes, because it is open-source under the MIT license.'
    },
    {
        question: 'What is the difference between Windster and Tailwind UI?',
        answer: 'Although both Windster and Tailwind UI are built for integration with Tailwind CSS, the main difference is in the design, the pages, the extra components and UI elements that Windster includes.',
        additionalContent: 'Additionally, Windster is a project that is still in development, and later it will include both the application, marketing, and e-commerce UI interfaces.'
    },
    {
        question: 'Can I use Windster in open-source projects?',
        answer: 'Generally, it is accepted to use Windster in open-source projects, as long as it is not a UI library, a theme, a template, a page-builder that would be considered as an alternative to Windster itself.',
        additionalContent: 'With that being said, feel free to use this design kit for your open-source projects. Find out more information by reading the license.'
    }
];