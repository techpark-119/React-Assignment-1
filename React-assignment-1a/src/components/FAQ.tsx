                    ...
                    <div>
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">
                                Feel free to <a
                                    href="#"
                                    className="text-gray-900 dark:text-white font-medium hover:no-underline"
                                    target="_blank"
                                    rel="noreferrer">
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">
                                Find out more information by <span className="font-medium text-gray-900 dark:text-white">reading the license.</span>
                            </p>
                        </div>
                    </div>
                    <div>
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">
                                The free updates that will be provided is based on the <a
                                    href="#"
                                    className="text-gray-900 dark:text-white font-medium hover:no-underline">
                                    roadmap</a> that we have laid out for this project. It is also possible that we
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">
                                The <a
                                    href="#"
                                    className="text-gray-900 dark:text-white font-medium hover:no-underline">
                                    free version</a> of Windster includes a minimal style guidelines, component variants,
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">
                                ...
                                <span className="font-medium text-gray-900 dark:text-white"> reading the license.</span>
                            </p>
                        </div>
                    </div>
                </div>
